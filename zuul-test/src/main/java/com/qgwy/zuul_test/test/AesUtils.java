 ...
 */
        ...
        String encryptedStr2=AesUtils.encryptCbcMode("{\"merchant_code\":\"6jdic7kc\",\"third_user_id\":\"123\",\"password\":\"1360089680326509\"},\"sign\":\"1d7a501da0627f682335c5be6293f978\"}", "1360089680326509","3901182040014755");
        System.out.println(encryptedStr2);
        String originalStr = AesUtils.decryptCbcMode(encryptedStr2, "1360089680326509", "3901182040014755");
        System.out.println(originalStr);
//        String encryptedStr2 = AesUtils.encryptEcbMode("{\"merchant_code\":\"6jdic7kc\",\"third_user_id\":\"123\",\"password\":\"1360089680326509\"},\"sign\":\"1d7a501da0627f682335c5be6293f978\"}", "aaaaa");

        //String originalStr2 = AesUtils.decryptEcbMode(encryptedStr2, "aaaa");
